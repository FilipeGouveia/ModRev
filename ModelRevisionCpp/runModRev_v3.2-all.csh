...
set folders = (fissionYeastDavidich2008 SP_1cell TCRsig40 boolean_cell_cycle thNetworkGarg2007)
    ...
    foreach it2 ($iterations)
        ...
        foreach folder ($folders)
            ...
            foreach e ($eprob)
                ...
                ./../../runsolver -w $output_dir/$t_dir/$folder/$it/watcher-$folder-$all-$e-$all-$all-net-att.txt -v $output_dir/$t_dir/$folder/$it/var-$folder-$all-$e-$all-$all-net-att.txt -C 600 -M 2048 $exec $input_dir/$folder/$it/$folder-$all-$e-$all-$all-net-att.lp > $output_dir/$folder/$it/$folder-$all-$e-$all-$all-net-att-repair.txt
